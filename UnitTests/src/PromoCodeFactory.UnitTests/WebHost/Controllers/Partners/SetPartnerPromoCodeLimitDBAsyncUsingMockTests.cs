...
{
    public class SetPartnerPromoCodeLimitDBAsyncUsingMockTests
    {
        private readonly IRepository<Partner> _partnersRepository;
        private readonly Mock<DataContext> _dataContextMock;

        public SetPartnerPromoCodeLimitDBAsyncUsingMockTests()
        {
            _dataContextMock = new Mock<DataContext>();
            _partnersRepository = new EfRepository<Partner>( _dataContextMock.Object );
        }
